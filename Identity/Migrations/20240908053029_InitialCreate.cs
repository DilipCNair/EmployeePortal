        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeDepartment = table.Column<int>(type: "integer", nullable: true),
                    EmpDesignation = table.Column<string>(type: "text", nullable: true),
                    ...
                    GovermentId = table.Column<string>(type: "text", nullable: true),
                    EmployeeGender = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PresentlyWorking = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeTaskId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskDocuments_EmployeeTasks_EmployeeTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskNotes_EmployeeTasks_EmployeeTaskId",
                        column: x => x.EmployeeTaskId,
                        principalTable: "EmployeeTasks",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskDocuments_EmployeeTaskId",
                table: "TaskDocuments",
                column: "EmployeeTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskNotes_EmployeeTaskId",
                table: "TaskNotes",
                column: "EmployeeTaskId");
